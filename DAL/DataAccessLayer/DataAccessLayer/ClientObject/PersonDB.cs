...
namespace ServerForTheLogic.ClientObject
{
    ...
    public class PersonDB
    {
        ...
        public PersonDB(Guid guid, string firstName, string lastName, int monthlyIncome, int accountBalance, string workPlaceID, int workplaceX, int workplaceY, string homeID, int homeX, int homeY, int daysLeft, int age, int startShift, int endShift)
        {
            Guid = guid;
            FirstName = firstName;
            LastName = lastName;
